...
class checkbox {
	...
	// Sign In Cashier (Вхід користувача (касира) за допомогою логіна та паролю)
	function getToken(){
	...
	// Get Cashier Profile (Отримання інформації про поточного користувача (касира))
	...
	// Get Cashier Shift (Отримання інформації про активну зміну користувача (касира))
	...
	// Create Shift (Відкриття нової зміни касиром)
	...
	// Get Shifts (Отримання змін поточного касира)
	...
	// Get Shift (Отримання інформації про зміну)
	...
	// Close Shift (Створення Z-Звіту та закриття поточної зміни користувачем (касиром).)
	...
	// Get Receipts (Отримання списку чеків в рамках поточної зміни або за параметрами фільтрів)
	...
	// Get Receipt (Отримання інформації про чек.)
	...
	// Create Receipt (Створення чеку продажу/повернення, його фіскалізація та доставка клієнту по email)
	...
	// Get Receipts Html, Pdf, Text, Qr Code Image (Отримання представлення чеку в форматах: HTML, PDF, для термопринтеру, зображення QR-коду чеку.) (type:html|pdf|text|qrcode)
	...
	// Create X Report (Генерація X звіту)
	...
	// Get Reports (Отримання звітів (X та Z) за поточну зміні або звіти за обрану дату)
